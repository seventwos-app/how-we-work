...
2. **First-Class Agent Identity**: AI agents (e.g., `Fact Checker`, `Technical Visualizer`) participate as first-class Matrix accounts or Application Service bots within shared rooms.
